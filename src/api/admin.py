...
from .models import db, User, Planet, Character, Films, Starships, Vehicles, Species, Favorites_Characters, Favorites_Planets, Favorites_Films, Favorites_Starships
